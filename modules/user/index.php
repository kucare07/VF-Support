...
if ($dept) { $where[] = "department_id = ?"; $params[] = $dept; }
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    ...
                    <form method="GET" action="">
                        <div class="row g-2">
                            <div class="col-md-3"><input type="text" name="q" class="form-control form-control-sm" placeholder="ค้นหาชื่อ, username..." value="<?= htmlspecialchars($search) ?>"></div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-auto"><a href="index.php" class="btn btn-sm btn-light border">Reset</a></div>
                        </div>
                    </form>
                </div>
